    ...
    sections:[
      ...
      },
      {
        ...
        fields:[
          ...
          { key:'vcfOpsPrimaryIp',   label:'VCF Operations Primary Node IP',   type:'ip',   sample:'10.11.99.52', showWhen:f=>f.vcfOpsInclude==='Include' },
          ...
          { key:'vcfOpsReplicaIp',   label:'VCF Operations Replica Node IP',   type:'ip',   sample:'10.11.99.53', showWhen:f=>f.vcfOpsInclude==='Include' },
          ...
          { key:'vcfOpsDataIp',      label:'VCF Operations Data Node IP',      type:'ip',   sample:'10.11.99.54', showWhen:f=>f.vcfOpsInclude==='Include' },
          ...
          { key:'vcfOpsLbIp',        label:'VCF Operations Load Balancer IP',  type:'ip',   sample:'10.11.99.21', showWhen:f=>f.vcfOpsInclude==='Include' },
          ...
          { key:'vcfOpsAdminPw',   label:'Admin Password',          type:'password', sample:'AUTO-GENERATED', showWhen:f=>f.vcfOpsInclude==='Include' },
        ]
      },
      {
        ...
        fields:[
          ...
          { key:'vcfAutoFqdn',     label:'VCF Automation FQDN (VIP)', type:'text',   sample:'sfo-m01-vra01.sfo.rainpole.io', showWhen:f=>f.vcfAutoInclude==='Include',
            notes:'1 FQDN for the VCF Automation VIP. Do not use capital letters in the FQDN (lowercase only).' },
          { key:'vcfAutoIp',       label:'VCF Automation IP (VIP)',  type:'ip',     sample:'10.11.99.25', showWhen:f=>f.vcfAutoInclude==='Include' },
          { key:'vcfAutoSvcRuntimeFqdn', label:'VCF Automation — Dedicated VCF Services Runtime FQDN', type:'text', sample:'sfo-vra-sr01.sfo.rainpole.io', showWhen:f=>f.vcfAutoInclude==='Include',
          ...
          { key:'vcfAutoSvcRuntimeIp',   label:'VCF Automation — Dedicated VCF Services Runtime IP',   type:'ip',   sample:'10.11.99.45', showWhen:f=>f.vcfAutoInclude==='Include' },
          { key:'vcfAutoIpPool1',  label:'VCF Automation Node IP Pool — Address 1', type:'ip',   sample:'10.11.99.46', showWhen:f=>f.vcfAutoInclude==='Include',
          ...
          { key:'vcfAutoIpPool2',  label:'VCF Automation Node IP Pool — Address 2', type:'ip',   sample:'10.11.99.47', showWhen:f=>f.vcfAutoInclude==='Include' },
          { key:'vcfAutoIpPool3',  label:'VCF Automation Node IP Pool — Address 3', type:'ip',   sample:'10.11.99.48', showWhen:f=>f.vcfAutoInclude==='Include' },
          { key:'vcfAutoIpPool4',  label:'VCF Automation Node IP Pool — Address 4 (buffer)', type:'ip',   sample:'10.11.99.49', showWhen:f=>f.vcfAutoInclude==='Include' },
          { key:'vcfAutoIpPool5',  label:'VCF Automation Node IP Pool — Address 5 (buffer)', type:'ip',   sample:'10.11.99.50', showWhen:f=>f.vcfAutoInclude==='Include' },
          { key:'vcfAutoAdminPw',  label:'Admin Password',          type:'password', sample:'AUTO-GENERATED', showWhen:f=>f.vcfAutoInclude==='Include' },
        ]
      },
      {
