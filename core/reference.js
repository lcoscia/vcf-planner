    ...
    sections:[
      ...
      },
      {
        ...
        fields:[
          ...
          { key:'az2OverlayVlan',     label:'AZ2 Host Overlay VLAN',       type:'number', sample:'1414', showWhen:f=>f.vsanStretchInclude==='Include', notes:'Per-AZ host TEP VLAN for the stretched cluster' },
          ...
          { key:'vsanWitnessIp',      label:'Witness Host Management IP',  type:'ip',   sample:'192.168.10.1', showWhen:f=>f.vsanStretchInclude==='Include' },
          { key:'vsanWitnessVcFqdn',  label:'Witness Hosting vCenter FQDN', type:'text', sample:'lax-m01-vc01.lax.rainpole.io', showWhen:f=>f.vsanStretchInclude==='Include', notes:'vCenter Server outside AZ1 and AZ2 that hosts the vSAN witness' },
          { key:'vsanWitnessDns1',    label:'Witness DNS Server #1',       type:'ip',   sample:'10.21.10.4', showWhen:f=>f.vsanStretchInclude==='Include' },
          ...
          { key:'vsanWitnessNtp',     label:'Witness NTP Server',          type:'text', sample:'ntp.lax.rainpole.io', showWhen:f=>f.vsanStretchInclude==='Include' },
          { key:'vsanWitnessRootPw',  label:'Witness Root Password',       type:'password', sample:'AUTO-GENERATED', showWhen:f=>f.vsanStretchInclude==='Include' },
        ]
      },
    ]
  },
